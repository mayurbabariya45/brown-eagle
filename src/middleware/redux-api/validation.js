...
function validateRSAA(action) {
    ...
    if (typeof headers !== 'undefined' && !_.isPlainObject(headers) && typeof headers !== 'function') {
        validationErrors.push('[RSAA].headers property must be undefined, a plain JavaScript object, or a funct' +
                'ion');
    }
    if (typeof options !== 'undefined' && !_.isPlainObject(options) && typeof options !== 'function') {
        validationErrors.push('[RSAA].options property must be undefined, a plain JavaScript object, or a funct' +
                'ion');
    }
