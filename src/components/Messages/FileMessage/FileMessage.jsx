...
export class FileMessage extends Component {
  ...
  onClick(e) {
    ...
    if (
      ...
      this.props.onDownload instanceof Function
    )
      this.props.onDownload(e);
    else if (
      this.props.data.status.download &&
      this.props.onOpen instanceof Function
    )
      this.props.onOpen(e);
  }
      ...
      <div className="rce-mbox-file">
        <button onClick={this.onClick.bind(this)}>
          <div className="rce-mbox-file--icon">
            <FaFile color="#aaa" />
            <div className="rce-mbox-file--size">{this.props.data.size}</div>
          </div>
          <div className="rce-mbox-file--text">{this.props.text}</div>
          <div className="rce-mbox-file--buttons">
            {this.props.data.status &&
              !this.props.data.status.download &&
              !this.props.data.status.click && <FaCloudDownload color="#aaa" />}
            {this.props.data.status &&
